...
import com.sid.encrypto.databinding.FragmentCardDetialsAddBinding
...
class CardDetailsAddFragment : Fragment() {
    ...
    private fun settingCardDetails() {
        ...
        binding.cardNumber.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                val str = input.length
                Log.d("PayView", "length: $str")

                binding.apply {
                    cardNumberOne.text = if (str >= 1) input.substring(0, minOf(4, str)) else ""
                    cardNumberTwo.text = if (str >= 5) input.substring(4, minOf(8, str)) else ""
                    cardNumberThree.text = if (str >= 9) input.substring(8, minOf(12, str)) else ""
                    cardNumberFour.text = if (str >= 13) input.substring(12, minOf(16, str)) else ""
                }
    ...
    private fun initialization() {
        ...
        binding.apply {
            btnSaveCardDetails.apply {
                this@CardDetailsAddFragment.buttonLayout = this.progressButtonBg
                this@CardDetailsAddFragment.buttonText = this.buttonText
                this@CardDetailsAddFragment.buttonText.text = getString(R.string.save_details)
                this@CardDetailsAddFragment.buttonProgress = this.buttonProgress
            }
        }
    }
